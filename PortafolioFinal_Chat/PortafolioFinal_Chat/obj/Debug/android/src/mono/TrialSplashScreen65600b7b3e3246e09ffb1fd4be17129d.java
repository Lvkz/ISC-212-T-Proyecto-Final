...
public class TrialSplashScreen65600b7b3e3246e09ffb1fd4be17129d extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen65600b7b3e3246e09ffb1fd4be17129d.this, portafoliofinal_chat.Login.class);
