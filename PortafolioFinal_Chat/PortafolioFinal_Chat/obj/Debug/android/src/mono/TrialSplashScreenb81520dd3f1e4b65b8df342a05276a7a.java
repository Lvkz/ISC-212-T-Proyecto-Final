...
public class TrialSplashScreenb81520dd3f1e4b65b8df342a05276a7a extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenb81520dd3f1e4b65b8df342a05276a7a.this, portafoliofinal_chat.Login.class);
