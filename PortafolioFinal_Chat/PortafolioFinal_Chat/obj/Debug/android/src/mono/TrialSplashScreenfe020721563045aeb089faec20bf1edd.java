...
public class TrialSplashScreenfe020721563045aeb089faec20bf1edd extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenfe020721563045aeb089faec20bf1edd.this, portafoliofinal_chat.Login.class);
