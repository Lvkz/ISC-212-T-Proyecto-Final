...
public class TrialSplashScreenedd0d9fc61d346798f5aa2130590ff5d extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenedd0d9fc61d346798f5aa2130590ff5d.this, portafoliofinal_chat.Login.class);
