...
public class TrialSplashScreen416ef92d30db4607ac4048bd75265e7a extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen416ef92d30db4607ac4048bd75265e7a.this, portafoliofinal_chat.Main.class);
