...
public class TrialSplashScreen570f81002ef349f19b263ffe8d8b4a42 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen570f81002ef349f19b263ffe8d8b4a42.this, portafoliofinal_chat.Login.class);
