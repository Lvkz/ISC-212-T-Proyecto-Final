...
public class TrialSplashScreen33600ebe80514de1a52ac2b189cd61cd extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen33600ebe80514de1a52ac2b189cd61cd.this, portafoliofinal_chat.Login.class);
