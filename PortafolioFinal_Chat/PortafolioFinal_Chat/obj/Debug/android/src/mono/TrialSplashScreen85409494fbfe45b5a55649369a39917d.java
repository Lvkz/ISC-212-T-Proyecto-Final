...
public class TrialSplashScreen85409494fbfe45b5a55649369a39917d extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen85409494fbfe45b5a55649369a39917d.this, portafoliofinal_chat.Login.class);
