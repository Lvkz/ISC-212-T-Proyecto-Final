...
public class TrialSplashScreen12044a013ebd43828e7e6757d1b86967 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen12044a013ebd43828e7e6757d1b86967.this, portafoliofinal_chat.Login.class);
