...
public class TrialSplashScreena37adc1eadf64fc8abdee8c4850ae297 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreena37adc1eadf64fc8abdee8c4850ae297.this, portafoliofinal_chat.Login.class);
