...
public class TrialSplashScreen8d687a2aed11489794b0ef03745b161a extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen8d687a2aed11489794b0ef03745b161a.this, portafoliofinal_chat.Login.class);
