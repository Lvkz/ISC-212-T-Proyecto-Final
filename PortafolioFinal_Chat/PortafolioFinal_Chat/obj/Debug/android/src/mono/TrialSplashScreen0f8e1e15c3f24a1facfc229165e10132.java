...
public class TrialSplashScreen0f8e1e15c3f24a1facfc229165e10132 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen0f8e1e15c3f24a1facfc229165e10132.this, portafoliofinal_chat.Login.class);
