...
public class TrialSplashScreen5e5d998809b24f9e88c348cfb7fdb18c extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen5e5d998809b24f9e88c348cfb7fdb18c.this, portafoliofinal_chat.Login.class);
