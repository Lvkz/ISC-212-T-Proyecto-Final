...
public class TrialSplashScreenf10bc5ee83c144bdb622a6dcd31d833b extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenf10bc5ee83c144bdb622a6dcd31d833b.this, portafoliofinal_chat.Login.class);
