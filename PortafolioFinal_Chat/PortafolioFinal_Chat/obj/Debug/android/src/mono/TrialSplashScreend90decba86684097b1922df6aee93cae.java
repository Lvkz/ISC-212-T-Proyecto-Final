...
public class TrialSplashScreend90decba86684097b1922df6aee93cae extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreend90decba86684097b1922df6aee93cae.this, portafoliofinal_chat.Login.class);
