...
public class TrialSplashScreenb309c4b3a20f47608175d73efacb8ae9 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenb309c4b3a20f47608175d73efacb8ae9.this, portafoliofinal_chat.Login.class);
