...
public class TrialSplashScreenba95015d2280477b9faf64271376e1fb extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenba95015d2280477b9faf64271376e1fb.this, portafoliofinal_chat.Login.class);
