...
public class TrialSplashScreencf9d2ce80a1f42198754a83c574197be extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreencf9d2ce80a1f42198754a83c574197be.this, portafoliofinal_chat.Main.class);
