...
public class TrialSplashScreend51dd73eb32a43e19f0a6e23c7b4cdfc extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreend51dd73eb32a43e19f0a6e23c7b4cdfc.this, portafoliofinal_chat.Login.class);
