...
public class TrialSplashScreen01b95b235262418582f4815a5bdc9696 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen01b95b235262418582f4815a5bdc9696.this, portafoliofinal_chat.Login.class);
