...
public class TrialSplashScreen778b5f5a11db40ae8408cd67da248397 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen778b5f5a11db40ae8408cd67da248397.this, portafoliofinal_chat.Login.class);
