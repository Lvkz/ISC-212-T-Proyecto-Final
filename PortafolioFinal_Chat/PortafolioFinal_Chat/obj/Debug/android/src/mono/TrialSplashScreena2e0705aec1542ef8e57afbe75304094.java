...
public class TrialSplashScreena2e0705aec1542ef8e57afbe75304094 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreena2e0705aec1542ef8e57afbe75304094.this, portafoliofinal_chat.Login.class);
