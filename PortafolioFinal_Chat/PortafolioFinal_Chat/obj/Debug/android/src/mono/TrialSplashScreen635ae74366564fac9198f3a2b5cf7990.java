...
public class TrialSplashScreen635ae74366564fac9198f3a2b5cf7990 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen635ae74366564fac9198f3a2b5cf7990.this, portafoliofinal_chat.Login.class);
