...
public class TrialSplashScreene1d79aeca8794d8cbbbcd03becccd52c extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreene1d79aeca8794d8cbbbcd03becccd52c.this, portafoliofinal_chat.Login.class);
