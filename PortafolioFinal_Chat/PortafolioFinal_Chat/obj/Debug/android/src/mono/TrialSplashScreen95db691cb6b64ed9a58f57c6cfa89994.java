...
public class TrialSplashScreen95db691cb6b64ed9a58f57c6cfa89994 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen95db691cb6b64ed9a58f57c6cfa89994.this, portafoliofinal_chat.Login.class);
