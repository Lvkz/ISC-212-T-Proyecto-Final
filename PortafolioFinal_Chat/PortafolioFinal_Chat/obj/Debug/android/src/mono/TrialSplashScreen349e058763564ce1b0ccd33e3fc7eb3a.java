...
public class TrialSplashScreen349e058763564ce1b0ccd33e3fc7eb3a extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen349e058763564ce1b0ccd33e3fc7eb3a.this, portafoliofinal_chat.Login.class);
