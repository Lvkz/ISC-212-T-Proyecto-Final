...
public class TrialSplashScreenc49a8e3d28d04d23aa004ef306df12dd extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenc49a8e3d28d04d23aa004ef306df12dd.this, portafoliofinal_chat.Login.class);
