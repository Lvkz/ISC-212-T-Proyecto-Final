...
public class TrialSplashScreen6b935dcfb66d4944a5ae8acc9b89086a extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen6b935dcfb66d4944a5ae8acc9b89086a.this, portafoliofinal_chat.Login.class);
