...
public class TrialSplashScreen2e20617b6b84495194706805dd95c7cc extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen2e20617b6b84495194706805dd95c7cc.this, portafoliofinal_chat.Login.class);
