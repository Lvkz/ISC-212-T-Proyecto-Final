...
public class TrialSplashScreena16f68a8653a42309a831359294f3b03 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreena16f68a8653a42309a831359294f3b03.this, portafoliofinal_chat.Main.class);
