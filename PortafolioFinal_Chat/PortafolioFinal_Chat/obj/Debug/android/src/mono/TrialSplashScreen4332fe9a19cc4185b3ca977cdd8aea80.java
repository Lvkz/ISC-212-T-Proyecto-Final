...
public class TrialSplashScreen4332fe9a19cc4185b3ca977cdd8aea80 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen4332fe9a19cc4185b3ca977cdd8aea80.this, portafoliofinal_chat.Login.class);
