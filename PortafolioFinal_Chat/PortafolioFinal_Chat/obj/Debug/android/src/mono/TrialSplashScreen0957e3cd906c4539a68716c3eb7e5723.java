...
public class TrialSplashScreen0957e3cd906c4539a68716c3eb7e5723 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen0957e3cd906c4539a68716c3eb7e5723.this, portafoliofinal_chat.Main.class);
