...
public class TrialSplashScreen56edf0cc69b940dcab1395f16df441cb extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen56edf0cc69b940dcab1395f16df441cb.this, portafoliofinal_chat.Login.class);
