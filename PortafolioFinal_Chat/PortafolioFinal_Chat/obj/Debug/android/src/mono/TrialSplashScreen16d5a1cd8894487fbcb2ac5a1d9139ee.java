...
public class TrialSplashScreen16d5a1cd8894487fbcb2ac5a1d9139ee extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen16d5a1cd8894487fbcb2ac5a1d9139ee.this, portafoliofinal_chat.Login.class);
