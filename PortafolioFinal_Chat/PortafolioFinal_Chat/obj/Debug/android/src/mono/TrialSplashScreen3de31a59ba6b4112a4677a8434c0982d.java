...
public class TrialSplashScreen3de31a59ba6b4112a4677a8434c0982d extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen3de31a59ba6b4112a4677a8434c0982d.this, portafoliofinal_chat.Login.class);
