...
public class TrialSplashScreen17fd2fff41644757bbd807cd3900232e extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen17fd2fff41644757bbd807cd3900232e.this, portafoliofinal_chat.Login.class);
