...
public class TrialSplashScreen2a38b0ee0fcd4f3fa39a8dab2e79021f extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen2a38b0ee0fcd4f3fa39a8dab2e79021f.this, portafoliofinal_chat.Login.class);
