...
public class TrialSplashScreenc24569add1eb4b1c9011c7236f1ed7b7 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenc24569add1eb4b1c9011c7236f1ed7b7.this, portafoliofinal_chat.Activity1.class);
