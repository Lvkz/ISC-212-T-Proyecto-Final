...
public class TrialSplashScreen8538bbc6cabb41939cc6a64dcfe4b1a5 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen8538bbc6cabb41939cc6a64dcfe4b1a5.this, portafoliofinal_chat.Login.class);
