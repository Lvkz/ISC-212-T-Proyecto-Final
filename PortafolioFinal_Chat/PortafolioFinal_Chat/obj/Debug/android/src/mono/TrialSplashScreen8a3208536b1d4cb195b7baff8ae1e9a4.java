...
public class TrialSplashScreen8a3208536b1d4cb195b7baff8ae1e9a4 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen8a3208536b1d4cb195b7baff8ae1e9a4.this, portafoliofinal_chat.Login.class);
