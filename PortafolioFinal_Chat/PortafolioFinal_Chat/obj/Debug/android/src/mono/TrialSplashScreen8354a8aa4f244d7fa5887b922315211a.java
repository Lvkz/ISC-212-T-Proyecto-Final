...
public class TrialSplashScreen8354a8aa4f244d7fa5887b922315211a extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen8354a8aa4f244d7fa5887b922315211a.this, portafoliofinal_chat.Login.class);
