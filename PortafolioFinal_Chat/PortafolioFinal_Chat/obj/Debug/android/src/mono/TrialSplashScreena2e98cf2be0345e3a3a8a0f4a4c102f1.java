...
public class TrialSplashScreena2e98cf2be0345e3a3a8a0f4a4c102f1 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreena2e98cf2be0345e3a3a8a0f4a4c102f1.this, portafoliofinal_chat.Login.class);
