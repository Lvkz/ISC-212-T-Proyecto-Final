...
public class TrialSplashScreenc7c2eddc97a0491c942c60bc0a9144eb extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenc7c2eddc97a0491c942c60bc0a9144eb.this, portafoliofinal_chat.Login.class);
