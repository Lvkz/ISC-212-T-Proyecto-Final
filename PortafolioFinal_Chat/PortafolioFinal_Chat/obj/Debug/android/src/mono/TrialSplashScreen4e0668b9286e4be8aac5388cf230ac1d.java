...
public class TrialSplashScreen4e0668b9286e4be8aac5388cf230ac1d extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen4e0668b9286e4be8aac5388cf230ac1d.this, portafoliofinal_chat.Login.class);
