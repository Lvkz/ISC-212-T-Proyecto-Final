...
public class TrialSplashScreen9433fd4a655245c1b0f13f4104538bf7 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen9433fd4a655245c1b0f13f4104538bf7.this, portafoliofinal_chat.Main.class);
