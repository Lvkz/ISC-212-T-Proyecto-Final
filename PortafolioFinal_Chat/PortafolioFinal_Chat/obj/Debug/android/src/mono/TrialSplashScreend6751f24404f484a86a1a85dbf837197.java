...
public class TrialSplashScreend6751f24404f484a86a1a85dbf837197 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreend6751f24404f484a86a1a85dbf837197.this, portafoliofinal_chat.Login.class);
