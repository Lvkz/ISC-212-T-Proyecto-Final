...
public class TrialSplashScreenc2fca3aa1adb487c9004775ce01d9f4f extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenc2fca3aa1adb487c9004775ce01d9f4f.this, portafoliofinal_chat.Login.class);
