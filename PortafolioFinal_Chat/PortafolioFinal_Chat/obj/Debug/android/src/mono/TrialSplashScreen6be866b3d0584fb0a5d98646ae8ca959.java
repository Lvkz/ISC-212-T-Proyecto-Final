...
public class TrialSplashScreen6be866b3d0584fb0a5d98646ae8ca959 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen6be866b3d0584fb0a5d98646ae8ca959.this, portafoliofinal_chat.Main.class);
