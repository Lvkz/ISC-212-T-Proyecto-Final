...
public class TrialSplashScreend0e12723bab048c1944c217aebe0a8db extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreend0e12723bab048c1944c217aebe0a8db.this, portafoliofinal_chat.Login.class);
